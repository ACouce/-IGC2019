...
#LOAD FILE
data<-read.table(file='Ara+5_timecourse.csv', sep = ",", header=T)
head(data)[1:15]
...
timepoints<-100 #choose window size

#PLOT
x11(width = 12, height = 5)
par(mfrow=c(1,1))
plot(generations[1:timepoints],data[2,6:(6+timepoints-1)], type='l', ylim=c(0,1), col='grey',lwd=0.35, xlab='generations', ylab='allele frequency', main='Ara+5')
